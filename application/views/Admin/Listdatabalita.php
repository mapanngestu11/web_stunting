                  ...
                  <tbody>
                    ...
                    foreach ($balita->result_array() as $row) :
                      ...
                      <tr>
                        ...
                        <?php }elseif ($hak_akses == 'Kader' || $hak_akses =='Admin') { ?>
                          <td>
                            <button class="btn-warning" data-toggle="modal" data-target="#editBalita<?php echo $id_data_balita;?>">Edit</button>
                          </td>
                          <td>
                            <button class="btn-danger" data-toggle="modal" data-target="#hapusBalita<?php echo $id_data_balita;?>">Hapus</button>
                          </td>
                        <?php } ?>
